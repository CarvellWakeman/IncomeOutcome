            ...
            debug.AddSetting(new Setting(inflater, R.drawable.ic_exclamation_white_24dp, "Structure rewrite testing", "", new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    for (int i = 0; i < bs.size(); i++){
                        ProfileManager.PrintLong(ActivitySettings.this, "Budget:" +
                                "\nName:" + bs.get(i).GetName() +
                                "\nStartDate:" + bs.get(i).GetStartDate().toString(ProfileManager.simpleDateFormat) +
                                "\nEndDate:" + bs.get(i).GetEndDate().toString(ProfileManager.simpleDateFormat) +
                        ...
                        for (int ii = 0; ii < ts.size(); ii++){
                            ProfileManager.PrintLong(ActivitySettings.this, "Transaction:" +
                                    ...
                                    "\nOccured:" + ts.get(ii).GetTimePeriod().GetDate().toString(ProfileManager.simpleDateFormat)
                            );
                        }
                    }
                }
