 ...
 */
public class MaterialSheetFabMod<FAB extends View & AnimatedFab> {
    ...
    private static final int FAB_ANIM_DURATION = 200 / ANIMATION_SPEED;
    private static final int SHOW_OVERLAY_ANIM_DURATION = MaterialSheetFabMod.SHOW_SHEET_ANIM_DELAY
            + SHEET_ANIM_DURATION;
    ...
    private static final float FAB_SCALE_FACTOR = 0.5f;
     ...
     */
    public MaterialSheetFabMod(FAB fab, View sheet, View overlay, int sheetColor, int fabColor) {
        ...
        fab.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        MaterialSheetFabMod.this.fab.getViewTreeObserver()
    ...
    private Side getFabArcSide(com.gordonwong.materialsheetfab.MaterialSheetFab.RevealXDirection revealXDirection) {
        if (revealXDirection == com.gordonwong.materialsheetfab.MaterialSheetFab.RevealXDirection.LEFT) {
            return Side.LEFT;
        } else {
            return Side.RIGHT;
        }
