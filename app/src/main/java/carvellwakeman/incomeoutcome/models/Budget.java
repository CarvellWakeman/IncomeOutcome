...
import java.util.*;
import carvellwakeman.incomeoutcome.models.TimePeriod.Repeat;
...
public class Budget implements java.io.Serializable, BaseEntity
{
    ...
    private ArrayList<Transaction> GetTransactions(Context context, LocalDate startDate, LocalDate endDate, Transaction.TRANSACTION_TYPE type, final Helper.SORT_METHODS sort, HashMap<Helper.FILTER_METHODS, String>  filters){
