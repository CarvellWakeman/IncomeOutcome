...
import carvellwakeman.incomeoutcome.helpers.CurrencyValueFormatter;
...
public class CardTransaction extends Card implements OnChartValueSelectedListener, SortFilterActivity
{
    ...
    private int keyType;
    private Transaction.TRANSACTION_TYPE _activityType;

    private CardView cardView;

    private Spinner spinner_keyType;

    private TextView textView_viewdetails;
    private LinearLayout button_viewDetails;
    ...
    // Filtering
    private HashMap<Helper.FILTER_METHODS, String> filterMethods;
