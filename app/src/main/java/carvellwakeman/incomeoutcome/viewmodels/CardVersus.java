...
public class CardVersus extends Card
{
    ...
    private int monthsBackMax = 20;
    private int monthsBackMin = 2;
    private int monthsBack = 5;
    ...
    private ImageView button_monthsBackUp;
    private ImageView button_monthsBackDown;
